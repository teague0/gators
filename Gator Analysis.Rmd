...
This returns goodness of fit calculated as a marginal (R2m -- fixed effects only) and a conditional (R2c -- fixed + random effects) value. Both are really low & its unsurprising we don't have any effects.
...
Ryan calculated an initial quantile regression for each quantile and suggested there were differences. I doubt it. Let's just look the median
```{r median quant reg}
